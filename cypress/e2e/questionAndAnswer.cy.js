...
describe('Boss Soru Cevap Testi', () => {
    ...
    it('Boss sorulan sorulara beklenen cevapları verir', () => {
        ...
        cy.wait(2500)
                    // SQL sorgusunu sormak için yeni mesaj gönder
                    cy.get("input[placeholder='Sorunuzu yazın...']").type("SQL sorgusunu yaz");
                    cy.get("button[aria-label='Mesaj gönder'] svg").click();
                    ...
                    // SQL cevabını al
                    cy.get(`body > div:nth-child(1) > div:nth-child(1) > main:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(${counter + 2}) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1)`)
                        .invoke('text')
                        .then((sqlQuery) => {
                            cy.log("SQL Sorgusu: " + sqlQuery);
